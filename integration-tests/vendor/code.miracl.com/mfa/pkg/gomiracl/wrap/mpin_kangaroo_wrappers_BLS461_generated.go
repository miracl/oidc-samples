...
// Server2BLS461Kangaroo is a wrapper of bindings.MPIN_BLS461_SERVER_2.
func Server2BLS461Kangaroo(d int, HID []byte, HTID []byte, y []byte, SS []byte, U []byte, UT []byte, V []byte, Pa []byte) (E []byte, F []byte, err error) {
	...
	ESize := bindings.GTSBLS461
	EOct := bindings.MakeOctet(ESize)
	defer EOct.Free()

	FSize := bindings.GTSBLS461
	...
	err = bindings.Server2BLS461(d, HIDOct, HTIDOct, yOct, SSOct, UOct, UTOct, VOct, EOct, FOct, PaOct)
...
// ServerBLS461Kangaroo is a wrapper of bindings.MPIN_BLS461_SERVER.
func ServerBLS461Kangaroo(h int, d int, SS []byte, U []byte, UT []byte, V []byte, ID []byte, MESSAGE []byte, t int, Pa []byte) (HID []byte, HTID []byte, y []byte, E []byte, F []byte, err error) {
	...
	err = bindings.ServerBLS461(h, d, HIDOct, HTIDOct, yOct, SSOct, UOct, UTOct, VOct, EOct, FOct, IDOct, MESSAGEOct, t, PaOct)
