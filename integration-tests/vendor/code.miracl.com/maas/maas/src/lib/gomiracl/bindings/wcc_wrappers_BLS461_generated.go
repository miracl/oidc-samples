...
func WCCRandomGenerateBLS461(RNG *Rand, S *Octet) error {
	...
	code := C.WCC_BLS461_RANDOM_GENERATE((*C.csprng)(RNG), SCOct)

	return newError(code)
}

// WCCHqBLS461 is a go wrapper for C.WCC_BLS461_Hq.
func WCCHqBLS461(h int, A *Octet, B *Octet, Ci *Octet, D *Octet, res *Octet) {
	...
	C.WCC_BLS461_Hq(C.int(h), ACOct, BCOct, CiCOct, DCOct, resCOct)
}
...
func WCCGetG1MultipleBLS461(S *Octet, HID *Octet, VG1 *Octet) error {
	...
	code := C.WCC_BLS461_GET_G1_MULTIPLE(SCOct, HIDCOct, VG1COct)
...
func WCCRecombineG1BLS461(R1 *Octet, R2 *Octet, R *Octet) error {
	...
	code := C.WCC_BLS461_RECOMBINE_G1(R1COct, R2COct, RCOct)
...
func WCCGetG2MultipleBLS461(S *Octet, HID *Octet, VG2 *Octet) error {
	...
	code := C.WCC_BLS461_GET_G2_MULTIPLE(SCOct, HIDCOct, VG2COct)
...
func WCCRecombineG2BLS461(W1 *Octet, W2 *Octet, W *Octet) error {
	...
	code := C.WCC_BLS461_RECOMBINE_G2(W1COct, W2COct, WCOct)
...
func WCCReceiverKeyBLS461(h int, y *Octet, w *Octet, pia *Octet, pib *Octet, PaG1 *Octet, PgG1 *Octet, BKeyG2 *Octet, IDA *Octet, AESKey *Octet) error {
	...
	code := C.WCC_BLS461_RECEIVER_KEY(C.int(h), yCOct, wCOct, piaCOct, pibCOct, PaG1COct, PgG1COct, BKeyG2COct, IDACOct, AESKeyCOct)
...
func WCCSenderKeyBLS461(h int, x *Octet, pia *Octet, pib *Octet, PbG2 *Octet, PgG1 *Octet, AKeyG1 *Octet, IDB *Octet, AESKey *Octet) error {
	...
	code := C.WCC_BLS461_SENDER_KEY(C.int(h), xCOct, piaCOct, pibCOct, PbG2COct, PgG1COct, AKeyG1COct, IDBCOct, AESKeyCOct)
