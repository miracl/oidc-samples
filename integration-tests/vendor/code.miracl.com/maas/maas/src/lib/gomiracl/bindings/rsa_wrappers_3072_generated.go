...
func RSADecrypt3072(priv RSAPrivateKey, G *Octet, F *Octet) {
	...
	C.RSA_3072_DECRYPT(priv.(*C.rsa_private_key_3072), GCOct, FCOct)
}
...
func RSAEncrypt3072(pub RSAPublicKey, F *Octet, G *Octet) {
	...
	C.RSA_3072_ENCRYPT(pub.(*C.rsa_public_key_3072), FCOct, GCOct)
}
...
func RSAKeyPair3072(rng *Rand, e int32, priv RSAPrivateKey, pub RSAPublicKey, p *Octet, q *Octet) {
	...
	C.RSA_3072_KEY_PAIR((*C.csprng)(rng), C.sign32(e), priv.(*C.rsa_private_key_3072), pub.(*C.rsa_public_key_3072), pCOct, qCOct)
}
